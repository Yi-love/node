...
function ChildProcess() {
  ...
  this.exitCode = null;
  this.killed = false;
  this.spawnfile = null;//opt.file

  this._handle = new Process();//子进程句柄
...
ChildProcess.prototype.spawn = function(options) {
  ...
  var err = this._handle.spawn(options);//创建子进程
  ...
  this.pid = this._handle.pid;//进程pid
...
/**
 * [_validateStdio description]
 * @param  {[type]} stdio [ipc类型]
 * @param  {[type]} sync  [是否为同步]
 * @return {[type]}       [description]
 */
